    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supporters', wagtail.fields.StreamField((('category', wagtail.blocks.StructBlock((('heading_text', wagtail.blocks.CharBlock(classname='title', required=True)), ('size', wagtail.blocks.ChoiceBlock(blank=True, choices=[('', 'Select a header size'), ('h2', 'H2'), ('h3', 'H3'), ('h4', 'H4')], required=False))))), ('supporter', wagtail.blocks.StructBlock((('name', wagtail.blocks.CharBlock(max_length=100)), ('summary', wagtail.blocks.TextBlock()), ('logo', wagtail.images.blocks.ImageChooserBlock(required=False)), ('url', wagtail.blocks.URLBlock(required=False)))))), blank=True)),
            ],
            options={

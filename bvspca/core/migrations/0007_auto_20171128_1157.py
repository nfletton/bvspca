    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture_blocks', wagtail.fields.StreamField((('animals_link', wagtail.blocks.ListBlock(wagtail.blocks.StructBlock((('title', wagtail.blocks.CharBlock(max_length=50)), ('image', wagtail.images.blocks.ImageChooserBlock()), ('page', wagtail.blocks.PageChooserBlock()))))),))),
            ],
            options={
